...
declare enum ShippingProfileType {
    DEFAULT = "default",
    GIFT_CARD = "gift_card",
    CUSTOM = "custom"
}
...
declare enum DiscountRuleType {
    FIXED = "fixed",
    PERCENTAGE = "percentage",
    FREE_SHIPPING = "free_shipping"
}
declare enum AllocationType {
    TOTAL = "total",
    ITEM = "item"
}
declare enum DiscountConditionType {
    PRODUCTS = "products",
...
declare enum DiscountConditionOperator {
    IN = "in",
    NOT_IN = "not_in"
}
...
declare enum ClaimPaymentStatus {
    NA = "na",
    NOT_REFUNDED = "not_refunded",
    REFUNDED = "refunded"
}
declare enum ClaimFulfillmentStatus {
    NOT_FULFILLED = "not_fulfilled",
    PARTIALLY_FULFILLED = "partially_fulfilled",
    FULFILLED = "fulfilled",
    PARTIALLY_SHIPPED = "partially_shipped",
...
declare enum PaymentCollectionStatus {
    NOT_PAID = "not_paid",
    AWAITING = "awaiting",
    AUTHORIZED = "authorized",
...
declare enum PaymentCollectionType {
...
declare enum SwapFulfillmentStatus {
    NOT_FULFILLED = "not_fulfilled",
    FULFILLED = "fulfilled",
    SHIPPED = "shipped",
    PARTIALLY_SHIPPED = "partially_shipped",
...
declare enum SwapPaymentStatus {
    NOT_PAID = "not_paid",
    AWAITING = "awaiting",
    CAPTURED = "captured",
    CONFIRMED = "confirmed",
