...
class ErrorBoundary extends React.Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="flex items-center justify-center h-screen px-large">
          <div className="max-w-[600px]">
            <div>
              <div>
                {this.state.status && (
                  <p className="opacity-75 text-grey-60 inter-small-semibold">
                    {this.state.status}
                  </p>
                )}
              ...
              <div className="flex items-center w-full  mt-xlarge">
                <Button
                  size="small"
                  variant="primary"
