import { AiSdkLogo, TextOnlyLogo, V0Logo, VercelLogo } from '~/components/logos';
...
As a core maintainer of Vercel's [AI SDK](https://ai-sdk.dev), I work on crafting the building blocks for AI-powered applications. I shipped a lightweight Model Context Protocol (MCP) client to enable native support for MCP tool invocation, and fixed critical bugs across streaming, abort signal propagation, tool invocation, and structured outputs. Most recently, I led the exploration and supported the refactor of the client-side stream state management and synchronization.
...
<VercelLogo text='AI Marketplace' />
...
<TextOnlyLogo text='Rotating Text' />
